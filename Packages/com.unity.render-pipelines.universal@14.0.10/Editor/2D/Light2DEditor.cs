...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal class Light2DEditor : PathComponentEditor<ScriptablePath>
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent generalShadowIntensity = EditorGUIUtility.TrTextContent("Shadow Intensity", "Adjusts the amount of light occlusion from the Shadow Caster 2D component(s) when blocking this light.The higher the value, the more opaque the shadow becomes.");
            public static GUIContent shadowRadius = EditorGUIUtility.TrTextContent("Shadow Radius", "");
        ...
        void DrawShadowsGroup()
        {
            ...
            EditorGUILayout.Slider(m_ShadowRadius, 0, 1, Styles.shadowRadius);
        }

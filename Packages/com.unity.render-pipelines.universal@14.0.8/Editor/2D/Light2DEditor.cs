...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal class Light2DEditor : PathComponentEditor<ScriptablePath>
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent generalShadowRadius = EditorGUIUtility.TrTextContent("Shadow Radius", "Shadow length");
        ...
        void DrawShadowsGroup()
        {
            ...
            EditorGUILayout.Slider(m_ShadowRadius, 0f, 1f, Styles.generalShadowRadius);
        }
